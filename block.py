...
def types(types_block, person_images):
    ...
    types_block[10] = Type_block("Leaves", True, 10, ss.image_at((0, 48, 48, 48)))
    types_block[11] = Type_block("Leaves1", True, 10, ss.image_at((48, 48, 48, 48)))
    types_block[12] = Type_block("Leaves2", True, 10, ss.image_at((96, 48, 48, 48)))
